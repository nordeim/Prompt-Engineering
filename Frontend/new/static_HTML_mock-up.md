...
<head>
  ...
  <meta name="theme-color" content="#4A3528">
  <title>Morning Brew Collective - Where Singapore's Morning Ritual Begins</title>
  ...
  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&family=Raleway:wght@400;500;600;700&display=swap" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div class="heritage-callout">
          <div class="callout-content">
            ...
            <a href="#order" class="cta-secondary">Reserve Your Table</a>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="locations-grid">
          <div class="location-card card scroll-animated">
            ...
            <div class="location-actions">
              ...
              <a href="#order" class="cta-secondary">Reserve Table</a>
            </div>
          </div>
    ...
    <footer class="footer" id="footer">
      <div class="container">
        ...
        <div class="footer-bottom">
          <p>&copy; 2026 Morning Brew Collective. All rights reserved.</p>
...
:root {
  /* ===== GRADIENT COLOR SYSTEM - DAWN TO NOON ===== */
  --color-dawn-cream: #FFF9F0;
  --color-terracotta-sunrise: #E68A66;
  --color-honey-gold: #D4A017;
  --color-avocado-leaf: #7D9A75;
  --color-coffee-brown: #4A3528;
  --color-clay-shadow: #B87355;
  --color-sky-dawn: #E8F4F8;
  ...
  /* ===== NAVIGATION ===== */
  --nav-height: 64px;
  --nav-bg-desktop: rgba(74, 53, 40, 0.85);
  --nav-bg-mobile: rgba(74, 53, 40, 0.95);
  --nav-shadow: 0 4px 12px rgba(74, 53, 40, 0.15);
  --nav-link-hover: rgba(230, 138, 102, 0.15);
  ...
  --color-terracotta-sunrise-rgb: 230, 138, 102;
  --color-ui-coral-rgb: 255, 107, 107;
...
.hero h1 {
  ...
  text-shadow: 2px 2px 4px rgba(184, 115, 85, 0.1);
  animation: fadeInUp var(--duration-slow) var(--easing-smooth) both;
}

.hero p {
  color: var(--color-ui-brown);
  animation: fadeInUp var(--duration-slow) calc(var(--duration-slow) + 0.2s) var(--easing-smooth) both;
  opacity: 0.9;
}
...
/* ===== LAYER 7: RESPONSIVE ENHANCEMENTS ===== */
...
.cta-secondary {
  ...
  color: var(--color-ui-terracotta);
  border: 2px solid var(--color-ui-terracotta);
}
...
.marker {
  ...
  background: var(--color-honey-gold);
  border-radius: 50%;
  box-shadow: 0 0 0 8px rgba(212, 160, 23, 0.5);
}
