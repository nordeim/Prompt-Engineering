# Translation Engine v9.0 — Complete Deliverable Set

Below are all 9 deliverable files, presented in dependency order. Each file is self-contained and separated by a horizontal rule.

---

## File 1 of 9: `Translation_Engine_v9_Prompt.md`
...
| # | File | Words | Purpose |
|---|---|---|---|
| 1 | `Translation_Engine_v9_Prompt.md` | ~4,400 | Core system prompt (14 sections) |
| 2 | `TE9_Pack_Engineering.md` | ~400 | Engineering domain pack (default) |
| 3 | `TE9_Pack_Legal.md` | ~450 | Legal domain pack |
| 4 | `TE9_Pack_Medical.md` | ~400 | Medical domain pack |
| 5 | `TE9_Pack_Financial.md` | ~400 | Financial domain pack |
| 6 | `TE9_FewShots.md` | ~2,200 | 9 calibration examples |
| 7 | `TE9_Changelog.md` | ~800 | v8→v9 migration guide |
| 8 | `TE9_DomainPack_Authoring_Guide.md` | ~500 | Custom pack creation guide |
| 9 | `TE9_wrapper_minimal.py` | ~250 (code) | Quick-start wrapper |

**Core prompt reduction:** ~4,400 words (v9) vs. ~8,500 words (v8) = **48% reduction**.
**Effective prompt for technical docs:** ~4,400 + ~400 (Engineering Pack) = **~4,800 words** vs. ~10,500 (v8 with all tables) = **54% reduction**.
**All v8 rules preserved.** Zero rules removed. All v8 fixes (Source-Script Leakage, Grammar Fluency, Markdown-Heavy Guidance, Comment-Policy Documentation) retained.
**Three ironclad improvements implemented:** micro-reminder cross-references, two-stage domain pack injection, relaxed IU semantics with cluster grouping.
