awesome understanding! please use the Meticulous Approach to do a deep dive research on how best to craft/create the most optimal system prompt for ChatGPT's LLM GPT-5, using the best Prompt Engineering techniques and best practices coupled with the GPT-5 effective prompting methodology mentioned in the guide below. With the best prompting knowledge for ChatGPT's GPT-5 that you have learned from your deep dive research and analysis, help me to create the most optimal and awesomely good system prompt for LLM like GPT-5 that I can use to create an AI Agent to help me with AI and ML research and related applications. You can use the ChatGPT sample dialogue as your sample for how such an AI Research Agent should at least perform.
